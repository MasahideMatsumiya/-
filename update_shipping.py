...
【配送サイズの読み方】
出荷票に「配送サイズ」という欄があり、CP・60・80・100 の選択肢があります。
その中で「囲まれている」「太字になっている」「ボックスで強調されている」ものが実際の配送サイズです。
選択されていないものは薄く表示されています。

shipping_size は以下から選んでください：
- "CP"  … クリックポスト（小型・薄型）
- "60"  … 60サイズの箱
- "80"  … 80サイズの箱
- "100" … 100サイズの箱

※商品の内容量（袋数）ではなく、配送箱のサイズを読んでください。
